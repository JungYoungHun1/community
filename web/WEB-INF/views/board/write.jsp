...
<c:if test="${requestScope.data.iboard > 0 && requestScope.data != null}">
...
<div class="flex-container flex-center flex-direction-column">
    ...
    <form action="${actionVal}" method="post">
        <div><input type="hidden" name="iboard" value="${iboardVal}"/></div>
        <div><input type="hidden" name="icategory" value="${icategoryVal}"></div>
